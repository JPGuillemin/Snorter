...
sub attacks{
	...
	@COLUMN=("WHOIS QUERY","SOURCE IP\@","Low","Medium","High","Hostility", "Bayes true", "Bayes false");
	...
	print "</TR>\n";
		for ($i = 0;  $i < $NUMBERHOST;	$i++) {
			...
			<IMG BORDER=0 width=40 height=22 SRC=\"./ripe.gif\" ALT=\"Whois\"></A></TD>
